  ...
  methods
    ...
    function obj = VelocityController(sample_frequency, cutoff_frequency, x_gains, y_gains, z_gains, vx_gains, vy_gains, vz_gains)
      ...
      arguments
        ...
        vx_gains = Control.Gains(25, 15, 0);
        vy_gains = Control.Gains(25, 15, 0);
        vz_gains = Control.Gains(25, 15, 0);
      end
      
      obj.x_pid = Control.PID(x_gains.kp, x_gains.ki, x_gains.kd, -1, 1, sample_frequency, cutoff_frequency);
