    ...
    methods
        ...
        function obj = PositionController(sample_frequency, cutoff_frequency, x_gains, y_gains, z_gains)
            ...
            arguments
                ...
                x_gains = Gains(.300, 0, .1);
                y_gains = Gains(.300, 0, .1);
                z_gains = Gains(1, 0, 0);
           end

            obj.x_pid = PID(x_gains.kp, x_gains.ki, x_gains.kd, -12, 12, sample_frequency, cutoff_frequency);
            obj.y_pid = PID(y_gains.kp, y_gains.ki, y_gains.kd, -12, 12, sample_frequency, cutoff_frequency);
            obj.z_pid = PID(z_gains.kp, z_gains.ki, z_gains.kd, -1, 1, sample_frequency, cutoff_frequency);
        end
